...
MODEL_PATH = "/app/models/"  # Path inside Docker container

# Dictionary to hold models by type and condition
loaded_models = {
    "autoencoder": {
        "adhd": tf.keras.models.load_model(os.path.join(MODEL_PATH,'auto_enc_adhd.h5')),
        "anxiety": tf.keras.models.load_model(os.path.join(MODEL_PATH,'auto_enc_anxiety.h5')),
        "ptsd": tf.keras.models.load_model(os.path.join(MODEL_PATH,'auto_enc_ptsd.h5')),
        "bipolar": tf.keras.models.load_model(os.path.join(MODEL_PATH,'auto_enc_bipolar.h5')),
        "depression": tf.keras.models.load_model(os.path.join(MODEL_PATH,'auto_enc_depression.h5'))
    },
    "fcnn": {
        "adhd": tf.keras.models.load_model(os.path.join(MODEL_PATH,'fcnn_adhd.h5')),
        "anxiety": tf.keras.models.load_model(os.path.join(MODEL_PATH,'fcnn_anxiety.h5')),
        "ptsd": tf.keras.models.load_model(os.path.join(MODEL_PATH,'fcnn_ptsd.h5')),
        "bipolar": tf.keras.models.load_model(os.path.join(MODEL_PATH,'fcnn_bipolar.h5')),
        "depression": tf.keras.models.load_model(os.path.join(MODEL_PATH,'fcnn_depression.h5'))
    },
    "resnet": {
        "adhd": tf.keras.models.load_model(os.path.join(MODEL_PATH,'resnet_adhd.h5')),
        "anxiety": tf.keras.models.load_model(os.path.join(MODEL_PATH,'resnet_anxiety.h5')),
        "ptsd": tf.keras.models.load_model(os.path.join(MODEL_PATH,'resnet_ptsd.h5')),
        "bipolar": tf.keras.models.load_model(os.path.join(MODEL_PATH,'resnet_bipolar.h5')),
        "depression": tf.keras.models.load_model(os.path.join(MODEL_PATH,'resnet_depression.h5'))
    }
}
